...
define config.name = _("Чистый берег: ДЗЗ и Челлендж")
...
define config.save_directory = "clean-1788555647"
...
init python:
    ...
    ## Исключить дублирующую корневую папку images/ (копия game/images/)
