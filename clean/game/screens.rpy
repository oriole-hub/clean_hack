...
style bar:
    ysize gui.bar_size
    left_bar Solid("#0a84ff")
    right_bar Solid("#2c2c2e")

style vbar:
    xsize gui.bar_size
    top_bar Solid("#0a84ff")
    bottom_bar Solid("#2c2c2e")

style scrollbar:
    ysize gui.scrollbar_size
    base_bar Solid("#2c2c2e")
    thumb Solid("#3a3a3c")
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Начать ДЗЗ-Тренажер") action Start()
